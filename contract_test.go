...
var contractCases = []contractCase{
	...
	{"Instagram.Posts", "ig-timeline-paged", "/instagram/profile/nasa/timeline?count=12&cursor=3950671748375397992_528817151",
	...
	{"AppStore.Reviews", "as-reviews", "/appstore/reviews?appId=389801252&country=us&page=1",
		func(ctx context.Context, c *Client) (any, error) {
	...
	{"GitHub.Followers", "gh-followers", "/github/profiles/torvalds/followers?limit=30&page=1",
		func(ctx context.Context, c *Client) (any, error) {
			return c.GitHub.Followers(ctx, "torvalds", &GitHubListParams{Limit: 30, Page: 1})
		}},
	{"GitHub.Following", "", "/github/profiles/torvalds/following?limit=5&page=1",
		func(ctx context.Context, c *Client) (any, error) {
			return c.GitHub.Following(ctx, "torvalds", &GitHubListParams{Limit: 5})
		}},
	{"GitHub.Repositories", "gh-repos", "/github/profiles/torvalds/repositories?limit=30&page=1",
		func(ctx context.Context, c *Client) (any, error) {
			return c.GitHub.Repositories(ctx, "torvalds", &GitHubListParams{Limit: 30})
		}},
	{"GitHub.SearchRepositories", "gh-search-repos", "/github/repositories?q=stars:%3E10000+language:php&limit=1&page=1",
		func(ctx context.Context, c *Client) (any, error) {
	...
	{"HackerNews.Feed", "hn-feed", "/hackernews/feeds/top?limit=20&page=0",
		func(ctx context.Context, c *Client) (any, error) {
	...
	{"HackerNews.Search", "hn-search", "/hackernews/search?q=postgres&limit=20&page=0",
		func(ctx context.Context, c *Client) (any, error) {
	...
	{"HackerNews.Submissions", "hn-user-submissions", "/hackernews/users/pg/submissions?limit=20&page=0",
		func(ctx context.Context, c *Client) (any, error) {
			return c.HackerNews.Submissions(ctx, "pg", &HackerNewsListParams{Limit: 20, Page: 0})
		}},
	{"HackerNews.Comments", "", "/hackernews/users/pg/comments?limit=10&page=0",
		func(ctx context.Context, c *Client) (any, error) {
	...
	{"Bluesky.Posts", "bs-posts", "/bluesky/profiles/bsky.app/posts?limit=25",
		func(ctx context.Context, c *Client) (any, error) {
...
func TestContract(t *testing.T) {
	for _, tc := range contractCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			if field := value.Elem().FieldByName("Data"); strings.HasPrefix(value.Elem().Type().Name(), "Page[") {
				value = field
			}
